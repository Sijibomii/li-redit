...
let UserResolver = class UserResolver {
    ...
    me({ req }) {
        ...
        console.log(req.session);
        return users_1.User.findOne(req.session.userId);
    }
    changePassword(token, newPassword, { redis, req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield users_1.User.findOne(userIdNum);
            if (!user) {
                return {
                    errors: [
                        {
            ...
            yield users_1.User.update({ id: userIdNum }, {
    ...
    login(usernameOrEmail, password, { req, res }) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield users_1.User.findOne(usernameOrEmail.includes("@")
...
__decorate([
    ...
    __metadata("design:paramtypes", [users_2.User, Object]),
...
UserResolver = __decorate([
    type_graphql_1.Resolver(users_2.User)
], UserResolver);
